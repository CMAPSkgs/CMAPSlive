...
server.register("/training/cadets/signalers", cdtTrainPageSig)
server.register("/training/cadets/operations", cdtTrainPageOps)
server.register("/training/cadets/admin", cdtTrainPageAdmin)
server.register("/training/cadets/q-store", cdtTrainPageQstore)
